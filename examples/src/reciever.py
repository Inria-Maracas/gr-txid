...
class reciever(gr.top_block):
    ...
    def __init__(self, center_freq=433e6, file_im='enreg_im', file_re='enreg_re', nb_samples_to_save=(600*(50000 + 2000)), samp_rate=5000000, tx_amount=21):
...
def main(top_block_cls=reciever, options=None):
    ...
    tb = top_block_cls(center_freq=options.center_freq, file_im=options.file_im, file_re=options.file_re, nb_samples_to_save=options.nb_samples_to_save, samp_rate=options.samp_rate, tx_amount=options.tx_amount)
