...
# Title: Reciever
# Generated: Mon Dec 10 15:59:01 2018
##################################################
...
class reciever(gr.top_block):
    ...
    def __init__(self, file_im='enreg_im', file_re='enreg_re', nb_samples_to_save=600*(50000 + 2000), tx_amount=21):
        gr.top_block.__init__(self, "Reciever")
        ...
        # Variables
        ##################################################
        self.usrp_tx_gain = usrp_tx_gain = 1
        self.usrp_rx_gain = usrp_rx_gain = 20
        self.symb_rate = symb_rate = 1250000
        ...
        self.blocks_file_sink_0_2 = blocks.file_sink(gr.sizeof_float*1, file_re, False)
        ...
        self.blocks_file_sink_0_0_1 = blocks.file_sink(gr.sizeof_float*1, file_im, False)
        ...
        # self.connect((self.blocks_complex_to_float_1_1, 1), (self.blocks_file_sink_0_0_1, 0))
        # self.connect((self.blocks_complex_to_float_1_1, 0), (self.blocks_file_sink_0_2, 0))
        ...
        self.connect((self.blocks_skiphead_0, 0), (self.learning_correlator_0, 0))
        # self.connect((self.blocks_skiphead_0, 0), (self.learning_head_1, 0))
        self.connect((self.digital_ofdm_rx_0, 0), (self.learning_data_switch_0, 0))
        self.connect((self.learning_correlator_0, 0), (self.learning_packet_isolator_c_0, 0))
        self.connect((self.learning_data_switch_0, 0), (self.learning_head_0, 0))
        self.connect((self.learning_data_switch_0, 1), (self.learning_head_0_0, 0))
        self.connect((self.learning_data_switch_0, 2), (self.learning_head_0_0_0, 0))
        self.connect((self.learning_data_switch_0, 13), (self.learning_head_0_0_0_0, 0))
        self.connect((self.learning_data_switch_0, 3), (self.learning_head_0_0_1, 0))
        self.connect((self.learning_data_switch_0, 14), (self.learning_head_0_0_1_0, 0))
        self.connect((self.learning_data_switch_0, 4), (self.learning_head_0_0_2, 0))
        self.connect((self.learning_data_switch_0, 15), (self.learning_head_0_0_2_0, 0))
        self.connect((self.learning_data_switch_0, 5), (self.learning_head_0_0_3, 0))
        self.connect((self.learning_data_switch_0, 16), (self.learning_head_0_0_3_0, 0))
        self.connect((self.learning_data_switch_0, 6), (self.learning_head_0_0_4, 0))
        self.connect((self.learning_data_switch_0, 17), (self.learning_head_0_0_4_0, 0))
        self.connect((self.learning_data_switch_0, 7), (self.learning_head_0_0_5, 0))
        self.connect((self.learning_data_switch_0, 18), (self.learning_head_0_0_5_0, 0))
        self.connect((self.learning_data_switch_0, 8), (self.learning_head_0_0_6, 0))
        self.connect((self.learning_data_switch_0, 19), (self.learning_head_0_0_6_0, 0))
        self.connect((self.learning_data_switch_0, 9), (self.learning_head_0_0_7, 0))
        self.connect((self.learning_data_switch_0, 20), (self.learning_head_0_0_7_0, 0))
        self.connect((self.learning_data_switch_0, 10), (self.learning_head_0_0_8, 0))
        self.connect((self.learning_data_switch_0, 12), (self.learning_head_0_0_9, 0))
        self.connect((self.learning_data_switch_0, 11), (self.learning_head_0_1, 0))
        self.connect((self.learning_head_0, 0), (self.blocks_complex_to_float_1, 0))
        self.connect((self.learning_head_0_0, 0), (self.blocks_complex_to_float_1_0, 0))
        self.connect((self.learning_head_0_0_0, 0), (self.blocks_complex_to_float_1_0_0, 0))
        self.connect((self.learning_head_0_0_0_0, 0), (self.blocks_complex_to_float_1_0_0_0, 0))
        self.connect((self.learning_head_0_0_1, 0), (self.blocks_complex_to_float_1_0_1, 0))
        self.connect((self.learning_head_0_0_1_0, 0), (self.blocks_complex_to_float_1_0_1_0, 0))
        self.connect((self.learning_head_0_0_2, 0), (self.blocks_complex_to_float_1_0_2, 0))
        self.connect((self.learning_head_0_0_2_0, 0), (self.blocks_complex_to_float_1_0_2_0, 0))
        self.connect((self.learning_head_0_0_3, 0), (self.blocks_complex_to_float_1_0_3, 0))
        self.connect((self.learning_head_0_0_3_0, 0), (self.blocks_complex_to_float_1_0_3_0, 0))
        self.connect((self.learning_head_0_0_4, 0), (self.blocks_complex_to_float_1_0_4, 0))
        self.connect((self.learning_head_0_0_4_0, 0), (self.blocks_complex_to_float_1_0_4_0, 0))
        self.connect((self.learning_head_0_0_5, 0), (self.blocks_complex_to_float_1_0_5, 0))
        self.connect((self.learning_head_0_0_5_0, 0), (self.blocks_complex_to_float_1_0_5_0, 0))
        self.connect((self.learning_head_0_0_6, 0), (self.blocks_complex_to_float_1_0_6, 0))
        self.connect((self.learning_head_0_0_6_0, 0), (self.blocks_complex_to_float_1_0_6_0, 0))
        self.connect((self.learning_head_0_0_7, 0), (self.blocks_complex_to_float_1_0_7, 0))
        self.connect((self.learning_head_0_0_7_0, 0), (self.blocks_complex_to_float_1_0_7_0, 0))
        self.connect((self.learning_head_0_0_8, 0), (self.blocks_complex_to_float_1_0_8, 0))
        self.connect((self.learning_head_0_0_9, 0), (self.blocks_complex_to_float_1_0_9, 0))
        self.connect((self.learning_head_0_1, 0), (self.blocks_complex_to_float_1_2, 0))
        # self.connect((self.learning_head_1, 0), (self.blocks_complex_to_float_1_1, 0))
        self.connect((self.learning_packet_isolator_c_0, 0), (self.digital_ofdm_rx_0, 0))
        self.connect((self.learning_packet_isolator_c_0, 0), (self.learning_data_switch_0, 1))
    ...
    def set_file_im(self, file_im):
        ...
        self.blocks_file_sink_0_0_1.open(self.file_im)
    ...
    def set_file_re(self, file_re):
        ...
        self.blocks_file_sink_0_2.open(self.file_re)
    ...
    def set_nb_samples_to_save(self, nb_samples_to_save):
        self.nb_samples_to_save = nb_samples_to_save
        self.learning_head_1.set_length(self.nb_samples_to_save/100)
        self.learning_head_0_1.set_length(self.nb_samples_to_save)
        self.learning_head_0_0_9.set_length(self.nb_samples_to_save)
        self.learning_head_0_0_8.set_length(self.nb_samples_to_save)
        self.learning_head_0_0_7_0.set_length(self.nb_samples_to_save)
        self.learning_head_0_0_7.set_length(self.nb_samples_to_save)
        self.learning_head_0_0_6_0.set_length(self.nb_samples_to_save)
        self.learning_head_0_0_6.set_length(self.nb_samples_to_save)
        self.learning_head_0_0_5_0.set_length(self.nb_samples_to_save)
        self.learning_head_0_0_5.set_length(self.nb_samples_to_save)
        self.learning_head_0_0_4_0.set_length(self.nb_samples_to_save)
        self.learning_head_0_0_4.set_length(self.nb_samples_to_save)
        self.learning_head_0_0_3_0.set_length(self.nb_samples_to_save)
        self.learning_head_0_0_3.set_length(self.nb_samples_to_save)
        self.learning_head_0_0_2_0.set_length(self.nb_samples_to_save)
        self.learning_head_0_0_2.set_length(self.nb_samples_to_save)
        self.learning_head_0_0_1_0.set_length(self.nb_samples_to_save)
        self.learning_head_0_0_1.set_length(self.nb_samples_to_save)
        self.learning_head_0_0_0_0.set_length(self.nb_samples_to_save)
        self.learning_head_0_0_0.set_length(self.nb_samples_to_save)
        self.learning_head_0_0.set_length(self.nb_samples_to_save)
        self.learning_head_0.set_length(self.nb_samples_to_save)
...
def argument_parser():
    ...
    parser.add_option(
        "-I", "--file-im", dest="file_im", type="string", default='enreg_im',
        help="Set I [default=%default]")
    parser.add_option(
        "-R", "--file-re", dest="file_re", type="string", default='enreg_re',
        help="Set R [default=%default]")
    parser.add_option(
        "-S", "--nb-samples-to-save", dest="nb_samples_to_save", type="intx", default=600*(50000 + 2000),
        help="Set nb_samples_to_save [default=%default]")
    parser.add_option(
        "-T", "--tx-amount", dest="tx_amount", type="intx", default=21,
        help="Set tx_amount [default=%default]")
    return parser
