...
class reciever(gr.top_block):
    ...
    def __init__(self, file_im='enreg_im', file_re='enreg_re', nb_samples_to_save=600*(50000 + 2000), tx_amount=21):
        ...
        self.txid_correlator_0 = txid.correlator((preamble), 1, 0, 0.3)
        ...
        self.connect((self.txid_data_switch_0, 2), (self.txid_head_0_0_0, 0))
        self.connect((self.txid_data_switch_0, 13), (self.txid_head_0_0_0_0, 0))
        self.connect((self.txid_data_switch_0, 3), (self.txid_head_0_0_1, 0))
        self.connect((self.txid_data_switch_0, 14), (self.txid_head_0_0_1_0, 0))
        self.connect((self.txid_data_switch_0, 4), (self.txid_head_0_0_2, 0))
        self.connect((self.txid_data_switch_0, 15), (self.txid_head_0_0_2_0, 0))
        self.connect((self.txid_data_switch_0, 5), (self.txid_head_0_0_3, 0))
        self.connect((self.txid_data_switch_0, 16), (self.txid_head_0_0_3_0, 0))
        self.connect((self.txid_data_switch_0, 6), (self.txid_head_0_0_4, 0))
        self.connect((self.txid_data_switch_0, 17), (self.txid_head_0_0_4_0, 0))
        self.connect((self.txid_data_switch_0, 7), (self.txid_head_0_0_5, 0))
        self.connect((self.txid_data_switch_0, 18), (self.txid_head_0_0_5_0, 0))
        self.connect((self.txid_data_switch_0, 8), (self.txid_head_0_0_6, 0))
        self.connect((self.txid_data_switch_0, 19), (self.txid_head_0_0_6_0, 0))
        self.connect((self.txid_data_switch_0, 9), (self.txid_head_0_0_7, 0))
        self.connect((self.txid_data_switch_0, 20), (self.txid_head_0_0_7_0, 0))
        self.connect((self.txid_data_switch_0, 10), (self.txid_head_0_0_8, 0))
        self.connect((self.txid_data_switch_0, 12), (self.txid_head_0_0_9, 0))
        self.connect((self.txid_data_switch_0, 11), (self.txid_head_0_1, 0))
...
def argument_parser():
    ...
    parser.add_option(
        ...
        help="Set file_im [default=%default]")
    parser.add_option(
        "-R", "--file-re", dest="file_re", type="string", default='enreg_re',
        help="Set file_re [default=%default]")
    parser.add_option(
